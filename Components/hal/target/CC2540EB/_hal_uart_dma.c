...
#define HAL_UART_DMA_RX_MAX        150
...
//#if DMA_PM
#if (DMA_PM == 1) //Á÷¿ØµÄÒý½ÅÖÐ¶Ï¿ÚºÍÎÒÃÇ¶¨ÒåµÄP1.0ÖÐ¶Ï¿Ú³åÍ»£¬ÖÐ¶Ïº¯ÊýÖ»ÄÜÓÐÒ»¸ö£¬ËùÒÔÖ»ÄÜ²»ÔÊÐíÕâÀï±àÒë½øÈ¥  hdf 2016.8.4
/**************************************************************************************************
