...
#define UART_SEND_EVT                                 0x0008
#define UART_EXTRACT_CMD_EVT                          0x0010
#define START_CONN_EVT                                0x0020
#define SEND_TO_AIR_EVT                               0x0040
#define DISC_BLE_CONNECT                              0x0080
  
#define USER_KEY_SCAN_EVT                             0x0100
...
#define MANU_DATA_LEN  16
typedef struct
{
  uint8 addr[B_ADDR_LEN];
  uint8 hasDataFlag;
  uint8 name[DEV_NAME_LEN];
  uint8 manuData[MANU_DATA_LEN];
}devInfo_t;
/*********************************************************************
 * FUNCTIONS
 */
